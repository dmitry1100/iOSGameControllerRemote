...
namespace UnityEngine.InputSystem.iOS.LowLevel
{
    ...
    internal unsafe struct iOSGameControllerRemoteState : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "dpad/up", bit = (uint)iOSButton.RightStick)]
        [InputControl(name = "dpad/right", bit = (uint)iOSButton.RightStick)]
        [InputControl(name = "dpad/down", bit = (uint)iOSButton.RightStick)]
        [InputControl(name = "dpad/left", bit = (uint)iOSButton.RightStick)]
        ...
        public iOSGameControllerRemoteState WithAxis(iOSAxis axis, float value)
        {
...
{
    [InputControlLayout(stateType = typeof(iOSGameControllerRemoteState), displayName = "iOS Gamepad Remote")]
    [Scripting.Preserve]
    public class iOSGameControllerRemote : Gamepad
    {
    }
}
